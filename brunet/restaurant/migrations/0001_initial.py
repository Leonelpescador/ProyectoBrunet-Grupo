# Generated by Django 5.1 on 2024-09-10 02:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_inicial', models.DecimalField(decimal_places=2, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('preparando', 'Preparando'), ('servido', 'Servido'), ('pagado', 'Pagado'), ('eliminado', 'Eliminado')], default='pendiente', max_length=10)),
                ('en_proceso', models.BooleanField(default=False)),
                ('numero_comanda', models.PositiveIntegerField(blank=True, null=True, unique=True)),
